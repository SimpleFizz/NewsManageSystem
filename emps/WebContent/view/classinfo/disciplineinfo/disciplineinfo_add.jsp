...
<form action="${pageContext.request.contextPath }/DisciplineController/addDisciplineInfo.action" class="form-horizontal" method="post">
	...
	<div class="row">
    	<div class="col-sm-5">
        	<div class="form-group">
                ...
                <div class="col-sm-9">
                	<input type="text" name="disciplineId" class="form-control input-sm" readonly="readonly" placeholder="请输入编号"/>
                </div>
            </div>
